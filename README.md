...
Database Schema:
1) customers — customer profile and acquisition segment
2) products — product catalogue with category and pricing
3) orders — transactional fact table linking customers to products
